-- Fix existing credit_listings table (Non-destructive)
...
-- 4. Add foreign key constraint for project_id
ALTER TABLE public.credit_listings 
ADD CONSTRAINT IF NOT EXISTS credit_listings_project_id_fkey 
